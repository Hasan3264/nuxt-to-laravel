<template>
    <div class="container mx-auto">
        ...
        <div class="max-w-xl mx-auto bg-white p-6 my-5 rounded shadow">
            <h2 class="text-2xl font-semibold mb-4 text-[#003F62]">Update Product</h2>
            <div class="card">
                ...
                <div v-else>
                    <form method="POST" enctype="multipart/form-data" @submit.prevent="submitProduct">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" v-model="product.image" id="image" name="image"
                                placeholder="Input Hosted Image Url only"
                                class="mt-1 p-2 w-full rounded border border-gray-300">
...
export default {
    ...
    methods: {
        ...
        submitProduct() {
            ...
            var myThis = this;
            axios.put(`http://127.0.0.1:8000/api/update/${this.ProductId}`, this.product).then(res => {
